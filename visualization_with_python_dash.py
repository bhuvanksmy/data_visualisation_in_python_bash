...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard",style={'textAlign': 'center', 'color': 'red'}),
    html.Div([
        html.Label("Select Statistics:",style={ 'color': 'white','font-weight': 'bold','font': '18px Arial, Helvetica, sans-serif'}),
        dcc.Dropdown(
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart2 = dcc.Graph(
            ...
            x='Month',
            y='Automobile_Sales',
            title='Monthly Automobile sales using line chart'))
